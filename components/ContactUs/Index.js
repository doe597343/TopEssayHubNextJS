export default function Index() {
    return <section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px]">
      ...
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          <p class="text-body-color mb-9 text-base leading-relaxed">
            If you have any questions, comments, or inquiries, we would love to hear from you. Please feel free to contact us using the information provided below:
          </p>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">support@topessayhub.com</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
          <form>
            ...
            <div>
              <button
                type="submit"
                class=" bg-yellow-300 border-primary w-full rounded border p-3 transition hover:bg-opacity-90"
              >
                Send Message
              </button>
            </div>
